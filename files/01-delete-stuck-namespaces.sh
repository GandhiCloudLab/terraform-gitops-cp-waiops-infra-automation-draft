...
# ----------------------------------------------------------------------------------------------------\\
# Description:
#   A  script to get rid of one or more namespace(s) stuck in terminating state for a ROKS  Env
#
#   Options:
...
echo -e "${tools}   Welcome to the Stuck Namespace Remover script for ROKS CloudPak";
if [ $# -lt 1 ]; then
  echo -e $USAGE
